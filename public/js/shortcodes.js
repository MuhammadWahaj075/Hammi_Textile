    ...
    var googleMap = function () {
                ...
                .gmap3({
                    map: {
                        options: {
                            ...
                            mapTypeId: 'Hammi-Architecture',
                            mapTypeControlOptions: {
                                mapTypeIds: ['Hammi-Architecture', google.maps.MapTypeId.SATELLITE, google.maps.MapTypeId.HYBRID]
                            },
                            scrollwheel: true
                        },
                    },
        ...
        $.each(data, function (key, val) {
            $('.themesflat-map').gmap3({
                ...
                styledmaptype: {
                    id: "Hammi-Architecture",
                    options: {
                        name: "Hammi-Architecture"
                    },
                    styles: [
                        {
