    ...
    <div className="row-about">
      <div className="container-fluid">
        <div className="row equalize sm-equalize-auto">
          <div className="col-md-6 half-background style-1"></div>
          <div className="col-md-6 bg-light-grey">
            ...
            >
              <div className="themesflat-headings style-1 clearfix">
                <h2 className="heading">WELCOME TO Hammi-Architecture</h2>
                <div className="sep has-width w80 accent-bg margin-top-11 clearfix"></div>
                <p className="sub-heading margin-top-30">
                  We have successfully completed projects in numerous states
                  across the continental United States. Hammi-Architecture
                  Construction Services has a proven track record of:
                </p>
              </div>
              <div
                className="themesflat-spacer clearfix"
                ...
                <div className="themesflat-list has-icon style-1 icon-left clearfix">
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        Completing projects on time & Following budget
                        guidelines
                      </span>
                    </span>
                  </div>
                ...
                <div className="themesflat-list has-icon style-1 icon-left clearfix">
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        Implementing appropriate safety precautions and
                        procedures
                      </span>
                    </span>
                  </div>
